...
class StudentVC: UIViewController {
    ...
    let spid = UserDefaults.standard.string(forKey: "spid")
       ...
       private let allNotice:UIButton = {
           ...
           button.setImage(UIImage(named: "N2.jpg"),for: .normal)
           return button
       }()
       ...
       override func viewDidLayoutSubviews() {
           ...
           allNotice.frame = CGRect(x: 0, y: semLableName.bottom + 2, width: 350, height: 350)
           icontext.frame = CGRect(x: 120, y: allNotice.bottom + 2, width: 150, height: 20)
           changepwd.frame = CGRect(x: 100, y: icontext.bottom + 2, width: view.width / 2, height: 50)
